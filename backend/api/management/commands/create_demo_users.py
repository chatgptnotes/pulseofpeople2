...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        try:
            ...
            self.stdout.write(self.style.WARNING(f'⚠️  Could not create organization: {e}'))
            self.stdout.write(self.style.WARNING('⚠️  Continuing without organization...'))
        ...
        for username, email, role, is_staff, is_superuser in demo_users:
            try:
                ...
                try:
                    ...
                    self.stdout.write(self.style.WARNING(f'⚠️  Profile error for {username}: {e}'))
